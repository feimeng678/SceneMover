...
class ACNet(object):
    ...
    def _build_net(self, scope):
        ...
        with tf.variable_scope('shared'):
            self.conv1 = tf.layers.conv2d(inputs=self.s,filters=32,kernel_size=[5, 5],strides=[2, 2],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                          name="conv1")
            ...
            self.conv2_1 = tf.layers.conv2d(inputs=self.conv1_out,filters=32,kernel_size=[3, 3],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            name="conv2_1")
            ...
            self.conv2_2 = tf.layers.conv2d(inputs=self.conv2_out_1,filters=32,kernel_size=[1, 1],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            name="conv2_2")
            ...
            self.conv3 = tf.layers.conv2d(inputs=self.conv2_out_2,filters=64,kernel_size=[3, 3],strides=[2, 2],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                          name="conv3")
            ...
            self.conv4_1 = tf.layers.conv2d(inputs=self.conv3_out,filters=64,kernel_size=[3, 3],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            name="conv4_1")
            ...
            self.conv4_2 = tf.layers.conv2d(inputs=self.conv4_out_1,filters=64,kernel_size=[1, 1],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            name="conv4_2")
            ...
            # self.conv5 = tf.layers.conv2d(inputs=self.conv4_out_2,filters=128,kernel_size=[3, 3],strides=[2, 2],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
            #                               name="conv5")
            #
            ...
            #
            # self.conv6_1 = tf.layers.conv2d(inputs=self.conv5_out,filters=128,kernel_size=[3, 3],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
            #                                 name="conv6_1")
            #
            ...
            #
            # self.conv6_2 = tf.layers.conv2d(inputs=self.conv6_out_1,filters=128,kernel_size=[1, 1],strides=[1, 1],padding="SAME",kernel_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
            #                                 name="conv6_2")
            #
            ...
            self.flatten = tf.contrib.layers.flatten(self.conv4_out_2)
            cell_size = 128
        ...
        with tf.variable_scope('actor'):
            ...
            l_a = tf.layers.dense(self.flatten_a1, 128, tf.nn.relu6, kernel_initializer=w_init, name='la')
            a_prob = tf.layers.dense(l_a, N_A, tf.nn.softmax, kernel_initializer=w_init, name='ap')
        with tf.variable_scope('critic'):
            l_c = tf.layers.dense(self.output_, 64, tf.nn.relu6, kernel_initializer=w_init, name='lc')
            v = tf.layers.dense(l_c, 1, kernel_initializer=w_init, name='v')  # state value
        shared_params = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope=scope + '/shared')
        a_params = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope=scope + '/actor')
        c_params = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope=scope + '/critic')
        a_params = a_params+shared_params
        c_params = c_params+shared_params
    ...
    def work(self):
        ...
        while not COORD.should_stop() and GLOBAL_EP < MAX_GLOBAL_EP:
            ...
            for ep_t in range(MAX_EP_STEP):
                ...
                if int(total_step / UPDATE_GLOBAL_ITER) % 100 == 0 and int(total_step / UPDATE_GLOBAL_ITER)>0:  # !!!!! have been modified!!
                    print('model %d saved' % (int(total_step / UPDATE_GLOBAL_ITER)))
                    saver.save(SESS, os.path.join(weight_path, 'model_%d.ckpt' % (int(total_step / UPDATE_GLOBAL_ITER))))
